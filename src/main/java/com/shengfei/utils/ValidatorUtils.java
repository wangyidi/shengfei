...
public class ValidatorUtils {
     ...
     *
     * @param objs
     * @return 至少有一个为空 返回 true 否者 false
     *
     */
    ...
    public static Boolean validate(Class cls ,BindingResult bindingResult){
        if (bindingResult.hasErrors()) {
            ...
            log.error(cls.getSimpleName()+"error : ",errors);
            return false;
        }
        return true ;
    }

    public static boolean isNotNullObject(Object object) throws IllegalAccessException {
        if (null == object) {
            return false;
        }
